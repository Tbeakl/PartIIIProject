...
add_initial_key_dist(variables, factors, number_of_bits, byte_hamming_weight_for_value.(key), 1, add_byte_hamming_weight_to_variable)
...
add_trace_to_factor_graph(encryption_trace, variables, factors, number_of_bits, 1, add_byte_hamming_weight_to_variable, add_byte_hamming_weight_to_variable)
