...
number_of_bits::Int64 = 8 #parse(Int64, ARGS[1])
...
key::Vector{UInt32} = all_keys[key_number]
nonce::Vector{UInt32} = all_nonces[key_number]
counter::UInt32 = all_counters[key_number]
