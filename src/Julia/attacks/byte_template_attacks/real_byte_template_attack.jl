...
path_for_locations = "D:/Year_4_Part_3/Dissertation/SourceCode/PartIIIProject/data/attack_profiling/second_template_set_best_templates_ge.hdf5"
...
every_downsampled_version::Vector{Vector{Vector{Float32}}} = []
for encryption_run_number in 1:number_of_encryption_traces
    ...
    push!(every_downsampled_version, all_downsampled_traces)
    # println("Here")
