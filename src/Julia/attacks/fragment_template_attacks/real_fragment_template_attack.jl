...
@everywhere function evaluate_key_number(number_of_bits::Int64,
    ...
    base_trace_path = "D:/Year_4_Part_3/Dissertation/SourceCode/PartIIIProject/data/captures/ChaChaRecordings_2/recording_attack_counter_from_random_"

    base_evaluation_of_ranks = "D:/Year_4_Part_3/Dissertation/SourceCode/PartIIIProject/data/evaluation/random_counter_1_16/"

    damping_factor::Float64 = 0.95

    result_path = string(base_evaluation_of_ranks, key_number, ".hdf5")
    if !ispath(result_path) # && key_number != 280
