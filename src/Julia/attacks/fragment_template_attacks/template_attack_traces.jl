...
function real_byte_template_path_to_function(base_path::String, bits_per_template::Int64, number_of_dimensions::Int64, traces::Matrix{Float32})
    ...
    return function add_byte_template_to_variable(trace::Vector{Float32},
        ...
        for template_number in 1:templates_per_intermediate_value
            fid = h5open(string(base_path, trace_mapping[position_in_trace], "_", template_number, "_template.hdf5"), "r")
...
function load_attack_trace(file_path::String, trace_number::Int64, encryption_run_number::Int64)
