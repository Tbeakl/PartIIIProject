...
function fill_column_index_with_current_values(locations_to_variable_names::Matrix{String},
    ...
    for word_num in 1:16
        for cluster_num in 1:clusters_per_word
            locations_to_variable_names[(word_num - 1) * clusters_per_word + cluster_num, column_index] = string(word_num, "_", location_execution_counts[word_num], "_", cluster_num)
        end
    end
end

function add_odd_round(locations_to_variable_names::Matrix{String}, location_execution_counts::Vector{Int64}, bits_per_cluster::Int64, clusters_per_word::Int64, initial_column_index::Int64)
        ...
        fill_column_index_with_current_values(locations_to_variable_names, location_execution_counts, clusters_per_word, initial_column_index)
        ...
        # Now print to the column_index
        fill_column_index_with_current_values(locations_to_variable_names, location_execution_counts, clusters_per_word, initial_column_index + 1)
        ...
        # Now print to the column_index
        fill_column_index_with_current_values(locations_to_variable_names, location_execution_counts, clusters_per_word, initial_column_index + 2)
        ...
        # Now print to the column_index
        fill_column_index_with_current_values(locations_to_variable_names, location_execution_counts, clusters_per_word, initial_column_index + 3)
        ...
        # Now print to the column_index
        fill_column_index_with_current_values(locations_to_variable_names, location_execution_counts, clusters_per_word, initial_column_index + 4)
        ...
        # Now print to the column_index
        fill_column_index_with_current_values(locations_to_variable_names, location_execution_counts, clusters_per_word, initial_column_index + 5)
end

function add_even_round(locations_to_variable_names::Matrix{String}, location_execution_counts::Vector{Int64}, bits_per_cluster::Int64, clusters_per_word::Int64, initial_column_index::Int64)
...
function make_positions_to_var_names(number_of_bits_per_cluster::Int64)
    ...
    fill_column_index_with_current_values(locations_to_variable_names, location_execution_counts, clusters_per_word, 1)
    for i in 1:10
        add_odd_round(locations_to_variable_names, location_execution_counts, number_of_bits_per_cluster, clusters_per_word, 2 + 12 * (i - 1))
        add_even_round(locations_to_variable_names, location_execution_counts, number_of_bits_per_cluster, clusters_per_word, 8 + 12 * (i - 1))
    end
    location_execution_counts[:] .+= 1
    # This is for after the final adds
    fill_column_index_with_current_values(locations_to_variable_names, location_execution_counts, clusters_per_word, 122)
