...
close(fid)
p = heatmap(visualisation_data, dpi=300, ylabel="ChaCha state", xlabel="Operation number", title="Round 50 entropies of variables", clim=(0,2))
...
close(fid)
p = heatmap(visualisation_data, dpi=300, ylabel="ChaCha state", xlabel="Operation number", title="Round 147 entropies of variables", clim=(0,1))
savefig(p, "./plots/factor_graph_findings/chacha_1bit_before_end.png")

fid = h5open(path_to_data_for_heatmaps * "tree_adds/2.hdf5", "r")
visualisation_data = read(fid["entropies_91"])
close(fid)
p = heatmap(visualisation_data, dpi=300, ylabel="ChaCha state", xlabel="Operation number", title="Round 91 entropies of variables", clim=(0,2))
...
close(fid)
p = heatmap(visualisation_data, dpi=300, ylabel="ChaCha state", xlabel="Operation number", title="Round 68 entropies of variables", clim=(0,4))
...
close(fid)
p = heatmap(visualisation_data, dpi=300, ylabel="ChaCha state", xlabel="Operation number", title="Round 61 entropies of variables", clim=(0,8))
...
close(fid)
p = heatmap(visualisation_data, dpi=300, ylabel="ChaCha state", xlabel="Operation number", title="Round 42 entropies of variables", clim=(0,2))
