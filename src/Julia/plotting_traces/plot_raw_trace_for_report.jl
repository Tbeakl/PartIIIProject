...
p = Plots.plot(times, power_trace .* power_gain .+ power_offset, size=(1500,500), ylabel="V", xlabel="Time (s)",
 ...
 title="Raw trace", guidefontsize=14, legendfontsize=14, titlefontsize=16, tickfontsize=10)
...
p = GRUtils.shade!(p, times, y; xlabel="Time (s)", ylabel="V", title="Raw trace", colormap=-GR.COLORMAP_BLUESCALE, figsize=(1500,500))
