...
fid = h5open("D:/Year_4_Part_3/Dissertation/SourceCode/PartIIIProject/data/attack_profiling/clock_cycles_bitmasks_no_dilation_2.hdf5", "r")
...
reduced_to_single_loc_per_intermediate_value = mapped_matrix[begin:4:end, :]
...
savefig(p, "./plots/heatmaps/NICV_interesting_cycles.png")