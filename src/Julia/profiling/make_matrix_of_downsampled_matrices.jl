...
numeber_of_samples_per_clock_cycle = 50
number_of_clock_cycles = (759500 ÷ numeber_of_samples_per_clock_cycle)
...
downsampled_matrix_100 = zeros(Float32, length(trace_range_per_file) * length(file_range), 379926)
...
for i in file_range
    ...
    for j in trace_range_per_file
        ...
        trimmed_raw_trace = trimmed_raw_trace[clock_cycle_sample_number:(end-(numeber_of_samples_per_clock_cycle-clock_cycle_sample_number)-1)]
...
fid = h5open("D:/Year_4_Part_3/Dissertation/SourceCode/PartIIIProject/data/attack_profiling/8_on_32_trace_set/validation_2.hdf5", "w")
fid["intermediate_values"] = all_intermediate_values
