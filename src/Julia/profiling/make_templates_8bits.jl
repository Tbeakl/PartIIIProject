...
data_path = "D:/Year_4_Part_3/Dissertation/SourceCode/PartIIIProject/data/attack_profiling/8_on_32_trace_set/"
...
# intermediate_value_index = 17
# template_num = 1
Threads.@threads for intermediate_value_index in 300:350 #number_of_intermediate_values
    ...
    for template_num in 1:number_of_templates_per_intermediate_value
        ...
        cycle_bitmask = dilate_after(cycle_bitmask, 2)
            sample_bitmask = Bool.(repeat(cycle_bitmask, inner= 50 ÷ 2)[1:379926])
