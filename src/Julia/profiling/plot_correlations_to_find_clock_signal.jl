...
savefig(p, "./plots/NICV_clock_signal.svg")
savefig(p, "./plots/NICV_clock_signal.pdf")
...
savefig(p, "./plots/Hamming_weight_clock_signal.svg")
savefig(p, "./plots/Hamming_weight_clock_signal.pdf")
...
savefig(p, "./plots/Linear_model_clock_signal.svg")
savefig(p, "./plots/Linear_model_clock_signal.pdf")
