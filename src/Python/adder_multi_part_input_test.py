...
factors: Dict[str, Factor] = {
    ...
    "input_b_0_dist": Factor("input_b_0_dist"),
    ...
    "input_b_1_dist": Factor("input_b_1_dist"),
...
variables["input_b_0"].add_neighbour(factors["input_b_0_dist"])
...
factors["input_b_0_dist"].add_neighbour(variables["input_b_0"])
...
variables["input_b_1"].add_neighbour(factors["input_b_1_dist"])
...
factors["input_b_1_dist"].add_neighbour(variables["input_b_1"])
...
p_input_b_0_array = np.zeros((1 << NUMBER_OF_BITS, 1))
p_input_a_1_array = np.zeros((1 << NUMBER_OF_BITS, 1))
p_input_b_1_array = np.zeros((1 << NUMBER_OF_BITS, 1))


p_carry_in_array[0] = 1.0
p_input_a_0_array[10] = 1.0
p_input_b_0_array[10] = 1.0
p_input_a_1_array[0] = 1.0
p_input_b_1_array[0] = 1.0


p_carry_in = LabeledArray(p_carry_in_array, ["carry_in"])
p_input_a_0 = LabeledArray(p_input_a_0_array, ["input_a_0"])
p_input_b_0 = LabeledArray(p_input_b_0_array, ["input_b_0"])
p_input_a_1 = LabeledArray(p_input_a_1_array, ["input_a_1"])
p_input_b_1 = LabeledArray(p_input_b_1_array, ["input_b_1"])
...
m = Messages()
print(f"Output 0 : {m.marginal(fg.variable_from_name('output_0'))}")
print(f"Carry out 0: {m.marginal(fg.variable_from_name('carry_out_0'))}")

print(f"Output 1 : {m.marginal(fg.variable_from_name('output_1'))}")
